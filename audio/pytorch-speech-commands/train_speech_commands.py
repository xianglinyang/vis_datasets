...
parser.add_argument("--train-dataset", type=str, default='/home/xianglin/projects/git_space/vis_datasets/audio/pytorch-speech-commands/datasets/speech_commands/train', help='path of train dataset')
parser.add_argument("--valid-dataset", type=str, default='/home/xianglin/projects/git_space/vis_datasets/audio/pytorch-speech-commands/datasets/speech_commands/valid', help='path of validation dataset')
parser.add_argument("--test-dataset", type=str, default='/home/xianglin/projects/git_space/vis_datasets/audio/pytorch-speech-commands/datasets/speech_commands/test', help='path of test dataset')
parser.add_argument("--background-noise", type=str, default='/home/xianglin/projects/git_space/vis_datasets/audio/pytorch-speech-commands/datasets/speech_commands/train/_background_noise_', help='path of background noise')
...
parser.add_argument("--model", choices=models.available_models, default="vgg19_bn", help='model of NN')
...
path = "/home/xianglin/projects/git_space/DLVisDebugger"
sys.path.append(path)
from writer.summary_writer import SummaryWriter
log_dir = "/home/xianglin/projects/DVI_data/{}_speechcomment".format(args.model) # User define
...
record_train_dataset = SpeechCommandsDataset(args.train_dataset, transform, silence_percentage=0)
record_trainloader = DataLoader(record_train_dataset, batch_size=args.batch_size, drop_last=False, shuffle=False)
test_dataset = SpeechCommandsDataset(args.test_dataset, transform, silence_percentage=0)
test_dataloader = DataLoader(test_dataset, batch_size=args.batch_size, shuffle=False,drop_last=False)


# >>>>>>>>>>Record Data
writer.add_training_data(record_trainloader) # use test_transform
writer.add_testing_data(test_dataloader)
# <<<<<<<<<
...
idxs = list(range(len(record_train_dataset)))
