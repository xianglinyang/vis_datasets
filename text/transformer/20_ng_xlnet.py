...
train_set = SSTDataset(dataset['train']['text'], dataset['train']['label'])
train_loader = DataLoader(train_set, shuffle=True, batch_size=2)
train_eval_loader = DataLoader(train_set, shuffle=False, batch_size=2)

dev_set = SSTDataset(dataset['test']['text'], dataset['test']['label'])
dev_eval_loader = DataLoader(dev_set, shuffle=False, batch_size=2)
